...
- **2026-08-28** — **T-7k3m** — Generalized solution selection into one reusable standard for resolving problems, planning work, testing results, and all other technical selections; the canonical criteria now cover existing public solutions, licenses, project health, security, dependencies, determinism, infrastructure, and cultural fit ([#53](https://github.com/pharzam/armature/issues/53); [detail](T-7k3m.md))
