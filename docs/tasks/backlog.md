...
- **T-8k5d** — Evaluate machine-readable metadata for the linted documents, to cut the shell parsers' size without spending the zero-toolchain POSIX `sh` property ([#61](https://github.com/pharzam/armature/issues/61); [ADR-0005](../adr/0005-independent-review-may-be-an-agent.md))
