...
| [0003](0003-adopt-issue-first-workflow.md)      | Adopt an issue-first workflow | Accepted. Amended by ADR-0004 |
| [0004](0004-destroying-history-on-the-default-branch.md) | Destroying history on the default branch | Accepted |
